    ...
    <header class="Head">
        <div class="Navbar">
            <ul class="nav">
                ...
                <li><button class="nav-link nav-link-ltr flt-right Lgmb fw"
                        onclick="document.getElementById('m1').style.display = 'block'">Login</button></li>
            </ul>
        </div>
    </header>
    <main id="Main">
            ...
            <form class="modal-content animate" method="post">
                ...
                <div class="modal-container" style="background-color: #f1f1f1">
                    ...
                    <div class="flex-inline">
                        <span class="reg"><a href='includes/register_page/reghome.php'
                                class="reg fw">Register</a></span>
                        <!--<span class="psw fw"><a>Forgot password?</a></span>-->
                        <button id="Psw" class="psw fw" type="button" method="post" onclick="Head();">Forgot
                            Password</button>
                        <script>var PswButton = document.getElementById('Psw');
                            function Head() {
                                window.location.href = 'http://localhost/Starbot/includes/register_page/reghome.php';
                            }
                        </script>
                    </div>
                </div>
